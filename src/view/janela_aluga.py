...
class JanelaAluga(Tk.Toplevel):
	...
	def __adicionarCampoCPF(self):
		...
		self.inputCPF = Tk.Entry(self.container).grid(column=1, row=0, sticky="WE", pady=(0,10))
	...
	def __adicionarCampoNome(self):
		...
		self.inputNome = Tk.Entry(self.container).grid(column=1, row=1, sticky="WE", pady=(0,10))
	
	def __adicionarCampoSenha(self):
		Tk.Label(self.container, text="Senha:").grid(column=0, row=2, sticky="W", pady=(0,10))
		self.inputSenha = Tk.Entry(self.container).grid(column=1, row=2, sticky="WE", pady=(0,10))
	...
	def setNome(self, nome):
		return self.inputNome.set(nome)
